...
var ReactTransition = function () {
    ...
    var renderComponent = function (Component, existingComponentId) { return (React.createElement(CSSAnimationTransitionWrapper, { key: existingComponentId, show: activeComponentId === existingComponentId, customClassName: activeComponentId === existingComponentId ? enterAnimation : existAnimation, timeout: 500, unmountOnExit: true },
